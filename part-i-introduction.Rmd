...
- Presentations and other course material available at https://github.com/osorensen/BayesCourseEPINOR2021
...
- Total probability equals probability given sick plus probability given not sick. $\bar{A}$ bar means "not A": 
...
- Should be defined **before** looking at the data, just like tests in a frequentist analysis should predefined to avoid p-hacking.
  ...
  - Which of course often is impossible in practice, but still good to keep in mind.
